...
1. Parse inputs:
  ...
  1.2 target branch to use to crerate the PR
  1.3 gh-token to create the PR
  1.4 working-directory where to check for dependencies
2. Excecute npm update command within the working directory
3. Check whether there are modified package*.json files
4. If there are no modified files
 4.1 Add commit files to the target branch
 4.2 Create a PR to the base branch using the oktokit API
5. Otherwise, exit gracefully
*/
